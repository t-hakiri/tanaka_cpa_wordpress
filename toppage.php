...
<div class="main">
  <section class="section js-section section1" data-section-name="section1">
    <div class="section-content">
      <div class="container top_content">
        <h1 class="top_title font-weight-bold">
          ’さらなる価値をお客様へ'
        </h1>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-12 col-lg-6 col-md-6 col-xs-12 section2_content">
              <h2>一歩踏み込む。</h2>
              <p>我々の自己満足ではなく、あくまでもお客様の目線で満足していただける会計・税務のサービス</p>
              <p>お客様の疑問や悩みに可能な限り早いレスポンスでの対応</p>
  ...
  <section class="section js-section section3 split_section" data-section-name="section3" id="section3">
    <div class="split_section_bg1" href="/contact"></div>
    <div class="split_section_bg2" id="split_section_bg2" href="/profile"></div>
    <div class="section-content">
      <div class="greeting_content">
        <a href="" class="btn btn-rouded mx-0 greeting_link1" id="greeting_link1">プロフィール</a>
        <a href="" class="btn btn-rouded mx-0 greeting_link2" id="greeting_link2">事業内容</a>
      </div>
    </div>
  </section>
  ...
  <section class="section js-section section5 split_section" data-section-name="section5" id="section5">
    <div class="split_section_bg1" href="/contact"></div>
    <div class="split_section2_bg2 business_bg" id="split_section2_bg2" href="/profile"></div>
    <div class="section-content">
      <div class="business_content">
        <a href="" class="btn btn-rouded mx-0 business_link1" id="business_link1">費用について</a>
        <a href="" class="btn btn-rouded mx-0 business_link2" id="business_link2">よくある質問</a>
      </div>
    </div>
  </section>
        ...
        <section class="dark-grey-text">
            ...
            <div class="d-flex align-items-center">
              <div class="container-fluid">
                ...
                <a href="" class="btn btn-orange btn-rouded company_btn">お問い合わせはこちら</a>
